...
parser.add_argument('--train_list', type=str, default="/data/action/something/sthv1_train_list_rawframes.txt")
parser.add_argument('--val_list', type=str, default="/data/action/something/sthv1_val_list_rawframes.txt")
parser.add_argument('--root_path', type=str, default="/data/action/something/rawframes")
...
parser.add_argument('--experiment_name', type=str, default='ESTI')
# ========================= Learning Configs ==========================
